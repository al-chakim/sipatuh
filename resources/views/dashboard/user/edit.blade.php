                ...
                <section id="multiple-column-form">
                    ...
                    <div class="row">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="alamat" type="text" value="{{ $user->alamat }}" class="form-control @error('Alamat') is-invalid @enderror" alamat="alamat" value="{{ old('alamat') }}" required autocomplete="alamat" autofocus>

                                <input alamat="id" type="hidden" value="{{ $user->id }}">
                        ...
                        <div class="row mb-0">
                            <div class="col-md-6 offset-md-4">
                                ...
                                <button type="reset" class="btn btn-outline-secondary" value="Go Back" onclick="history.back(-1)">Reset</button>
                            </div>
                                            {{-- <div class="col-12">
