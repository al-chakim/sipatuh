    ...
    <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            <li class="{{ Request::is('adling*') ? 'active' : 'nav-item' }} "><a class="d-flex align-items-center"
                    href="/home"><i data-feather="home"></i><span class="menu-title text-truncate"
            ...
            <li class="#"><a class="d-flex align-items-center" href="#"><i data-feather="octagon"></i><span
                ...
                <ul class="menu-content">
                    ...
                    <!-- kepatuhan -->
                    <li class="{{ Request::is('kantor6a*') ? 'active' : 'nav-item' }}"><a
                            class="d-flex align-items-center" href="/kantor6a"><i data-feather="codepen"></i><span
                    ...
                    <li class="#"><a class="d-flex align-items-center" href="#"><i
                        ...
                        <ul class="menu-content">
                            <li class="{{ Request::is('kantor7a*') ? 'active' : 'nav-item' }}"><a
                                    class="d-flex align-items-center" href="/kantor7a">
                                    <span class="menu-item text-truncate" data-i18n="List">1. Penyampaian
                                        Dokumen</span></a>
                            </li>
                            <li class="{{ Request::is('kantor7b*') ? 'active' : 'nav-item' }}"><a
                                    class="d-flex align-items-center" href="/kantor7b">
                                    <span class="menu-item text-truncate" data-i18n="List">2. Sertifikat Hasil
                                        Uji</span></a>
                            </li>
                            <li class="{{ Request::is('kantor7c*') ? 'active' : 'nav-item' }}"><a
                                    class="d-flex align-items-center" href="/kantor7c">
                    ...
                    <!-- PPL & DPL -->
                    <li class="{{ Request::is('kantor8a*') ? 'active' : 'nav-item' }}"><a
                            class="d-flex align-items-center" href="/kantor8a"><i data-feather="framer"></i><span
                                class="menu-title text-truncate">PPL & DPL</span></a>
                    </li>
                    <!-- Kepatuhan Kinerja -->
                    <li class="{{ Request::is('kantor9a*') ? 'active' : 'nav-item' }}"><a
                            class="d-flex align-items-center" href="/kantor9a"><i data-feather="grid"></i><span
                                class="menu-title text-truncate">Kepatuhan
                                Kinerja</span></a>
                    </li>
                </ul>
            </li>
            ...
            <li class="#"><a class="d-flex align-items-center" href="#"><i data-feather="grid"></i><span
                ...
                <ul class="menu-content">
                    ...
                    <!-- kepatuhan -->
                    <li class="{{ Request::is('bogor6a*') ? 'active' : 'nav-item' }}"><a
                            class="d-flex align-items-center" href="/bogor6a"><i data-feather="codepen"></i><span
                                class="menu-title text-truncate">Kepatuhan</span></a>
                    </li>
                    <!-- plh -->
                    <li class="#"><a class="d-flex align-items-center" href="#"><i
                                data-feather="codesandbox"></i><span class="menu-title text-truncate">PLH</span></a>
                        <ul class="menu-content">
                            <li class="{{ Request::is('bogor7a*') ? 'active' : 'nav-item' }}"><a
                                    class="d-flex align-items-center" href="/bogor7a">
                                    <span class="menu-item text-truncate" data-i18n="List">1. Penyampaian
                                        Dokumen</span></a>
                            </li>
                            <li class="{{ Request::is('bogor7b*') ? 'active' : 'nav-item' }}"><a
                                    class="d-flex align-items-center" href="/bogor7b">
                                    <span class="menu-item text-truncate" data-i18n="List">2. Sertifikat Hasil
                                        Uji</span></a>
                            </li>
                            <li class="{{ Request::is('bogor7c*') ? 'active' : 'nav-item' }}"><a
                                    class="d-flex align-items-center" href="/bogor7c">
                                    <span class="menu-item text-truncate" data-i18n="List">3. Laporan Neraca
                                        LB3</span></a>
                            </li>
                        </ul>
                    ...
                    <!-- PPL & DPL -->
                    <li class="{{ Request::is('bogor8a*') ? 'active' : 'nav-item' }}"><a
                            class="d-flex align-items-center" href="/bogor8a"><i data-feather="framer"></i><span
                                class="menu-title text-truncate">PPL & DPL</span></a>
                    </li>
                    <!-- Kepatuhan Kinerja -->
                    <li class="{{ Request::is('bogor9a*') ? 'active' : 'nav-item' }}"><a
                            class="d-flex align-items-center" href="/bogor9a"><i data-feather="grid"></i><span
                                class="menu-title text-truncate">Kepatuhan
                                Kinerja</span></a>
                    </li>
                </ul>
            ...
            <li class="#"><a class="d-flex align-items-center" href="#"><i
                ...
                <ul class="menu-content">
                    ...
                    <!-- kepatuhan -->
                    <li class="{{ Request::is('banjar6a*') ? 'active' : 'nav-item' }}"><a
                            class="d-flex align-items-center" href="/banjar6a"><i data-feather="codepen"></i><span
                                class="menu-title text-truncate">Kepatuhan</span></a>
                    </li>
                    <!-- plh -->
                    <li class="#"><a class="d-flex align-items-center" href="#"><i
                                data-feather="codesandbox"></i><span class="menu-title text-truncate">PLH</span></a>
                        <ul class="menu-content">
                            <li class="{{ Request::is('banjar7a*') ? 'active' : 'nav-item' }}"><a
                                    class="d-flex align-items-center" href="/banjar7a">
                                    <span class="menu-item text-truncate" data-i18n="List">1. Penyampaian
                                        Dokumen</span></a>
                            </li>
                            <li class="{{ Request::is('banjar7b*') ? 'active' : 'nav-item' }}"><a
                                    class="d-flex align-items-center" href="/banjar7b">
                                    <span class="menu-item text-truncate" data-i18n="List">2. Sertifikat Hasil
                                        Uji</span></a>
                            </li>
                            <li class="{{ Request::is('banjar7c*') ? 'active' : 'nav-item' }}"><a
                                    class="d-flex align-items-center" href="/banjar7c">
                                    <span class="menu-item text-truncate" data-i18n="List">3. Laporan Neraca
                                        LB3</span></a>
                            </li>
                        </ul>
                    ...
                    <!-- PPL & DPL -->
                    <li class="{{ Request::is('banjar8a*') ? 'active' : 'nav-item' }}"><a
                            class="d-flex align-items-center" href="/banjar8a"><i data-feather="framer"></i><span
                                class="menu-title text-truncate">PPL & DPL</span></a>
                    </li>
                    <!-- Kepatuhan Kinerja -->
                    <li class="{{ Request::is('banjar9a*') ? 'active' : 'nav-item' }}"><a
                            class="d-flex align-items-center" href="/banjar9a"><i data-feather="grid"></i><span
                                class="menu-title text-truncate">Kepatuhan
                                Kinerja</span></a>
                    </li>
                </ul>
            ...
            <li class="#"><a class="d-flex align-items-center" href="#"><i data-feather="figma"></i><span
                ...
                <ul class="menu-content">
                    ...
                    <!-- kepatuhan -->
                    <li class="{{ Request::is('jakarta6a*') ? 'active' : 'nav-item' }}"><a
                            class="d-flex align-items-center" href="/jakarta6a"><i data-feather="codepen"></i><span
                                class="menu-title text-truncate">Kepatuhan</span></a>
                    </li>
                    <!-- plh -->
                    <li class="#"><a class="d-flex align-items-center" href="#"><i
                                data-feather="codesandbox"></i><span class="menu-title text-truncate">PLH</span></a>
                        <ul class="menu-content">
                            <li class="{{ Request::is('jakarta7a*') ? 'active' : 'nav-item' }}"><a
                                    class="d-flex align-items-center" href="/jakarta7a">
                                    <span class="menu-item text-truncate" data-i18n="List">1. Penyampaian
                                        Dokumen</span></a>
                            </li>
                            <li class="{{ Request::is('jakarta7b*') ? 'active' : 'nav-item' }}"><a
                                    class="d-flex align-items-center" href="/jakarta7b">
                                    <span class="menu-item text-truncate" data-i18n="List">2. Sertifikat Hasil
                                        Uji</span></a>
                            </li>
                            <li class="{{ Request::is('jakarta7c*') ? 'active' : 'nav-item' }}"><a
                                    class="d-flex align-items-center" href="/jakarta7c">
                                    <span class="menu-item text-truncate" data-i18n="List">3. Laporan Neraca
                                        LB3</span></a>
                            </li>
                        </ul>
                    ...
                    <!-- PPL & DPL -->
                    <li class="{{ Request::is('jakarta8a*') ? 'active' : 'nav-item' }}"><a
                            class="d-flex align-items-center" href="/jakarta8a"><i data-feather="framer"></i><span
                                class="menu-title text-truncate">PPL & DPL</span></a>
                    </li>
                    <!-- Kepatuhan Kinerja -->
                    <li class="{{ Request::is('jakarta9a*') ? 'active' : 'nav-item' }}"><a
                            class="d-flex align-items-center" href="/jakarta9a"><i data-feather="grid"></i><span
                                class="menu-title text-truncate">Kepatuhan
                                Kinerja</span></a>
                    </li>
                </ul>
            ...
            <li class="#"><a class="d-flex align-items-center" href="#"><i
                ...
                <ul class="menu-content">
                    ...
                    <!-- kepatuhan -->
                    <li class="{{ Request::is('makasar6a*') ? 'active' : 'nav-item' }}"><a
                            class="d-flex align-items-center" href="/makasar6a"><i data-feather="codepen"></i><span
                                class="menu-title text-truncate">Kepatuhan</span></a>
                    </li>
                    <!-- plh -->
                    <li class="#"><a class="d-flex align-items-center" href="#"><i
                                data-feather="codesandbox"></i><span class="menu-title text-truncate">PLH</span></a>
                        <ul class="menu-content">
                            <li class="{{ Request::is('makasar7a*') ? 'active' : 'nav-item' }}"><a
                                    class="d-flex align-items-center" href="/makasar7a">
                                    <span class="menu-item text-truncate" data-i18n="List">1. Penyampaian
                                        Dokumen</span></a>
                            </li>
                            <li class="{{ Request::is('makasar7b*') ? 'active' : 'nav-item' }}"><a
                                    class="d-flex align-items-center" href="/makasar7b">
                                    <span class="menu-item text-truncate" data-i18n="List">2. Sertifikat Hasil
                                        Uji</span></a>
                            </li>
                            <li class="{{ Request::is('makasar7c*') ? 'active' : 'nav-item' }}"><a
                                    class="d-flex align-items-center" href="/makasar7c">
                                    <span class="menu-item text-truncate" data-i18n="List">3. Laporan Neraca
                                        LB3</span></a>
                            </li>
                        </ul>
                    ...
                    <!-- PPL & DPL -->
                    <li class="{{ Request::is('makasar8a*') ? 'active' : 'nav-item' }}"><a
                            class="d-flex align-items-center" href="/makasar8a"><i data-feather="framer"></i><span
                                class="menu-title text-truncate">PPL & DPL</span></a>
                    </li>
                    <!-- Kepatuhan Kinerja -->
                    <li class="{{ Request::is('makasar9a*') ? 'active' : 'nav-item' }}"><a
                            class="d-flex align-items-center" href="/makasar9a"><i data-feather="grid"></i><span
                                class="menu-title text-truncate">Kepatuhan
                                Kinerja</span></a>
                    </li>
                </ul>
            ...
            <li class="#"><a class="d-flex align-items-center" href="#"><i
                ...
                <ul class="menu-content">
                    ...
                    <!-- kepatuhan -->
                    <li class="{{ Request::is('padang6a*') ? 'active' : 'nav-item' }}"><a
                            class="d-flex align-items-center" href="/padang6a"><i data-feather="codepen"></i><span
                                class="menu-title text-truncate">Kepatuhan</span></a>
                    </li>
                    <!-- plh -->
                    <li class="#"><a class="d-flex align-items-center" href="#"><i
                                data-feather="codesandbox"></i><span class="menu-title text-truncate">PLH</span></a>
                        <ul class="menu-content">
                            <li class="{{ Request::is('padang7a*') ? 'active' : 'nav-item' }}"><a
                                    class="d-flex align-items-center" href="/padang7a">
                                    <span class="menu-item text-truncate" data-i18n="List">1. Penyampaian
                                        Dokumen</span></a>
                            </li>
                            <li class="{{ Request::is('padang7b*') ? 'active' : 'nav-item' }}"><a
                                    class="d-flex align-items-center" href="/padang7b">
                                    <span class="menu-item text-truncate" data-i18n="List">2. Sertifikat Hasil
                                        Uji</span></a>
                            </li>
                            <li class="{{ Request::is('padang7c*') ? 'active' : 'nav-item' }}"><a
                                    class="d-flex align-items-center" href="/padang7c">
                                    <span class="menu-item text-truncate" data-i18n="List">3. Laporan Neraca
                                        LB3</span></a>
                            </li>
                        </ul>
                    ...
                    <!-- PPL & DPL -->
                    <li class="{{ Request::is('padang8a*') ? 'active' : 'nav-item' }}"><a
                            class="d-flex align-items-center" href="/padang8a"><i data-feather="framer"></i><span
                                class="menu-title text-truncate">PPL & DPL</span></a>
                    </li>
                    <!-- Kepatuhan Kinerja -->
                    <li class="{{ Request::is('padang9a*') ? 'active' : 'nav-item' }}"><a
                            class="d-flex align-items-center" href="/padang9a"><i data-feather="grid"></i><span
                                class="menu-title text-truncate">Kepatuhan
                                Kinerja</span></a>
                    </li>
                </ul>
            ...
            <li class="#"><a class="d-flex align-items-center" href="#"><i
                ...
                <ul class="menu-content">
                    ...
                    <!-- kepatuhan -->
                    <li class="{{ Request::is('palembang6a*') ? 'active' : 'nav-item' }}"><a
                            class="d-flex align-items-center" href="/palembang6a"><i data-feather="codepen"></i><span
                                class="menu-title text-truncate">Kepatuhan</span></a>
                    </li>
                    <!-- plh -->
                    <li class="#"><a class="d-flex align-items-center" href="#"><i
                                data-feather="codesandbox"></i><span class="menu-title text-truncate">PLH</span></a>
                        <ul class="menu-content">
                            <li class="{{ Request::is('palembang7a*') ? 'active' : 'nav-item' }}"><a
                                    class="d-flex align-items-center" href="/palembang7a">
                                    <span class="menu-item text-truncate" data-i18n="List">1. Penyampaian
                                        Dokumen</span></a>
                            </li>
                            <li class="{{ Request::is('palembang7b*') ? 'active' : 'nav-item' }}"><a
                                    class="d-flex align-items-center" href="/palembang7b">
                                    <span class="menu-item text-truncate" data-i18n="List">2. Sertifikat Hasil
                                        Uji</span></a>
                            </li>
                            <li class="{{ Request::is('palembang7c*') ? 'active' : 'nav-item' }}"><a
                                    class="d-flex align-items-center" href="/palembang7c">
                                    <span class="menu-item text-truncate" data-i18n="List">3. Laporan Neraca
                                        LB3</span></a>
                            </li>
                        </ul>
                    ...
                    <!-- PPL & DPL -->
                    <li class="{{ Request::is('palembang8a*') ? 'active' : 'nav-item' }}"><a
                            class="d-flex align-items-center" href="/palembang8a"><i data-feather="framer"></i><span
                                class="menu-title text-truncate">PPL & DPL</span></a>
                    </li>
                    <!-- Kepatuhan Kinerja -->
                    <li class="{{ Request::is('palembang9a*') ? 'active' : 'nav-item' }}"><a
                            class="d-flex align-items-center" href="/palembang9a"><i data-feather="grid"></i><span
                                class="menu-title text-truncate">Kepatuhan
                                Kinerja</span></a>
                    </li>
                </ul>
            ...
            <li class="#"><a class="d-flex align-items-center" href="#"><i
                ...
                <ul class="menu-content">
                    ...
                    <!-- kepatuhan -->
                    <li class="{{ Request::is('pandaan6a*') ? 'active' : 'nav-item' }}"><a
                            class="d-flex align-items-center" href="/pandaan6a"><i
                    ...
                    <li class="#"><a class="d-flex align-items-center" href="#"><i
                                data-feather="codesandbox"></i><span class="menu-title text-truncate">PLH</span></a>
                        <ul class="menu-content">
                            <li class="{{ Request::is('pandaan7a*') ? 'active' : 'nav-item' }}"><a
                                    class="d-flex align-items-center" href="/pandaan7a">
                                    <span class="menu-item text-truncate" data-i18n="List">1. Penyampaian
                                        Dokumen</span></a>
                            </li>
                            <li class="{{ Request::is('pandaan7b*') ? 'active' : 'nav-item' }}"><a
                                    class="d-flex align-items-center" href="/pandaan7b">
                                    <span class="menu-item text-truncate" data-i18n="List">2. Sertifikat Hasil
                                        Uji</span></a>
                            </li>
                            <li class="{{ Request::is('pandaan7c*') ? 'active' : 'nav-item' }}"><a
                                    class="d-flex align-items-center" href="/pandaan7c">
                                    <span class="menu-item text-truncate" data-i18n="List">3. Laporan Neraca
                                        LB3</span></a>
                            </li>
                        </ul>
                    ...
                    <!-- PPL & DPL -->
                    <li class="{{ Request::is('pandaan8a*') ? 'active' : 'nav-item' }}"><a
                            class="d-flex align-items-center" href="/pandaan8a"><i data-feather="framer"></i><span
                                class="menu-title text-truncate">PPL &
                                DPL</span></a>
                    </li>
                    <!-- Kepatuhan Kinerja -->
                    <li class="{{ Request::is('pandaan9a*') ? 'active' : 'nav-item' }}"><a
                            class="d-flex align-items-center" href="/pandaan9a"><i data-feather="grid"></i><span
                                class="menu-title text-truncate">Kepatuhan
                                Kinerja</span></a>
                    </li>
                </ul>
            ...
            <li class="#"><a class="d-flex align-items-center" href="#"><i
                ...
                <ul class="menu-content">
                    ...
                    <!-- kepatuhan -->
                    <li class="{{ Request::is('semar6a*') ? 'active' : 'nav-item' }}"><a
                            class="d-flex align-items-center" href="/semar6a"><i data-feather="codepen"></i><span
                                class="menu-title text-truncate">Kepatuhan</span></a>
                    </li>
                    <!-- plh -->
                    <li class="#"><a class="d-flex align-items-center" href="#"><i
                                data-feather="codesandbox"></i><span class="menu-title text-truncate">PLH</span></a>
                        <ul class="menu-content">
                            <li class="{{ Request::is('semar7a*') ? 'active' : 'nav-item' }}"><a
                                    class="d-flex align-items-center" href="/semar7a">
                                    <span class="menu-item text-truncate" data-i18n="List">1. Penyampaian
                                        Dokumen</span></a>
                            </li>
                            <li class="{{ Request::is('semar7b*') ? 'active' : 'nav-item' }}"><a
                                    class="d-flex align-items-center" href="/semar7b">
                                    <span class="menu-item text-truncate" data-i18n="List">2. Sertifikat Hasil
                                        Uji</span></a>
                            </li>
                            <li class="{{ Request::is('semar7c*') ? 'active' : 'nav-item' }}"><a
                                    class="d-flex align-items-center" href="/semar7c">
                                    <span class="menu-item text-truncate" data-i18n="List">3. Laporan Neraca
                                        LB3</span></a>
                            </li>
                        </ul>
                    ...
                    <!-- PPL & DPL -->
                    <li class="{{ Request::is('semar8a*') ? 'active' : 'nav-item' }}"><a
                            class="d-flex align-items-center" href="/semar8a"><i data-feather="framer"></i><span
                                class="menu-title text-truncate">PPL &
                                DPL</span></a>
                    </li>
                    <!-- Kepatuhan Kinerja -->
                    <li class="{{ Request::is('semar9a*') ? 'active' : 'nav-item' }}"><a
                            class="d-flex align-items-center" href="/semar9a"><i data-feather="grid"></i><span
                                class="menu-title text-truncate">Kepatuhan
                                Kinerja</span></a>
                    </li>
                </ul>
            ...
            <li class="#"><a class="d-flex align-items-center" href="#"><i
                ...
                <ul class="menu-content">
                    ...
                    <!-- kepatuhan -->
                    <li class="{{ Request::is('sura6a*') ? 'active' : 'nav-item' }}"><a
                            class="d-flex align-items-center" href="/sura6a"><i data-feather="codepen"></i><span
                                class="menu-title text-truncate">Kepatuhan</span></a>
                    </li>
                    <!-- plh -->
                    <li class="#"><a class="d-flex align-items-center" href="#"><i
                                data-feather="codesandbox"></i><span class="menu-title text-truncate">PLH</span></a>
                        <ul class="menu-content">
                            <li class="{{ Request::is('sura7a*') ? 'active' : 'nav-item' }}"><a
                                    class="d-flex align-items-center" href="/sura7a">
                                    <span class="menu-item text-truncate" data-i18n="List">1. Penyampaian
                                        Dokumen</span></a>
                            </li>
                            <li class="{{ Request::is('sura7b*') ? 'active' : 'nav-item' }}"><a
                                    class="d-flex align-items-center" href="/sura7b">
                                    <span class="menu-item text-truncate" data-i18n="List">2. Sertifikat Hasil
                                        Uji</span></a>
                            </li>
                            <li class="{{ Request::is('sura7c*') ? 'active' : 'nav-item' }}"><a
                                    class="d-flex align-items-center" href="/sura7c">
                                    <span class="menu-item text-truncate" data-i18n="List">3. Laporan Neraca
                                        LB3</span></a>
                            </li>
                        </ul>
                    ...
                    <!-- PPL & DPL -->
                    <li class="{{ Request::is('sura8a*') ? 'active' : 'nav-item' }}"><a
                            class="d-flex align-items-center" href="/sura8a"><i data-feather="framer"></i><span
                                class="menu-title text-truncate">PPL &
                                DPL</span></a>
                    </li>
                    <!-- Kepatuhan Kinerja -->
                    <li class="{{ Request::is('sura9a*') ? 'active' : 'nav-item' }}"><a
                            class="d-flex align-items-center" href="/sura9a"><i data-feather="grid"></i><span
                                class="menu-title text-truncate">Kepatuhan
                                Kinerja</span></a>
                    </li>
                </ul>
            ...
            <li class="#"><a class="d-flex align-items-center" href="#"><i
                ...
                <ul class="menu-content">
                    ...
                    <!-- kepatuhan -->
                    <li class="{{ Request::is('tun6a*') ? 'active' : 'nav-item' }}"><a
                            class="d-flex align-items-center" href="/tun6a"><i data-feather="codepen"></i><span
                                class="menu-title text-truncate">Kepatuhan</span></a>
                    </li>
                    <!-- plh -->
                    <li class="#"><a class="d-flex align-items-center" href="#"><i
                                data-feather="codesandbox"></i><span class="menu-title text-truncate">PLH</span></a>
                        <ul class="menu-content">
                            <li class="{{ Request::is('tun7a*') ? 'active' : 'nav-item' }}"><a
                                    class="d-flex align-items-center" href="/tun7a">
                                    <span class="menu-item text-truncate" data-i18n="List">1. Penyampaian
                                        Dokumen</span></a>
                            </li>
                            <li class="{{ Request::is('tun7b*') ? 'active' : 'nav-item' }}"><a
                                    class="d-flex align-items-center" href="/tun7b">
                                    <span class="menu-item text-truncate" data-i18n="List">2. Sertifikat Hasil
                                        Uji</span></a>
                            </li>
                            <li class="{{ Request::is('tun7c*') ? 'active' : 'nav-item' }}"><a
                                    class="d-flex align-items-center" href="/tun7c">
                                    <span class="menu-item text-truncate" data-i18n="List">3. Laporan Neraca
                                        LB3</span></a>
                            </li>
                        </ul>
                    ...
                    <!-- PPL & DPL -->
                    <li class="{{ Request::is('tun8a*') ? 'active' : 'nav-item' }}"><a
                            class="d-flex align-items-center" href="/tun8a"><i data-feather="framer"></i><span
                                class="menu-title text-truncate">PPL &
                                DPL</span></a>
                    </li>
                    <!-- Kepatuhan Kinerja -->
                    <li class="{{ Request::is('tun9a*') ? 'active' : 'nav-item' }}"><a
                            class="d-flex align-items-center" href="/tun9a"><i data-feather="grid"></i><span
                                class="menu-title text-truncate">Kepatuhan
                                Kinerja</span></a>
                    </li>
                </ul>
