                        ...
                        @can('is_user')
                            ...
                            @can('is_admin')
                                ...
                                <div class="col-md-4 col-sm-6 col-12 kb-search-content">
                                    <div class="card">
                                        <a href="/adling">
                                            <img src="../../../app-assets/images/illustration/verify-email-illustration.svg" class="card-img-top"
                                                alt="knowledge-base-image" style="max-height: 65%" />
                                            <div class="card-body text-center">
                                                <h4>Lingkungan</h4>
