                ...
                <div class="auth-wrapper auth-cover">
                    <div class="auth-inner row m-0">
                            ...
                            <a class="brand-logo" href="#">
                                    <img class="image" border="0" src="../../../app-assets/images/pages/bumn.png" width="160px" height="40px" style="margin: 0px 0% 0px -3%;padding: 0px;">
                                    <img class="image" border="0" src="../../../app-assets/images/pages/hsse.jpeg" width="45px" height="60px" style="margin: -0.5% 20% 0px 19%;padding: 0px;">
                                    <img class="image" border="0" src="../../../app-assets/images/pages/pln12.png" width="100px" height="40px" style="margin: 0px 0% 0px 0px;padding: 0px;">
                                    {{-- <h2 class="brand-text text-primary ms-1">PLN UDIKLAT</h2> --}}
                                </a>

                        <!-- /Brand logo-->
                        <!-- Left Text-->
                         <div class="d-none d-lg-flex col-lg-8 align-items-center p-5">
                            <div class="w-100 d-lg-flex align-items-center justify-content-center px-5"><img class="img-fluid" src="../../../app-assets/images/pages/cover.jpeg" width="400px" height="160px" alt="Login V2" /></div>
                        </div>
                        <!-- /Left Text-->
                        <!-- Login-->
                        <div class="d-flex col-lg-4 align-items-center auth-bg px-2 p-lg-5">
                            <div class="col-12 col-sm-8 col-md-6 col-lg-12 px-xl-2 mx-auto">
                                <center>
                                <img class="image" border="0" src="../../../app-assets/images/pages/patuh123.png" width="300px" style="margin: 0px;padding: 0px color:white;">
                                </center>
