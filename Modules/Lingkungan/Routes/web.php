...
use Modules\Lingkungan\Http\Controllers\TteController;
...
Route::prefix('Lingkungan')->middleware('auth')->group(function() {
    ...
    // tte user
    Route::get('/tte1', [TteController::class, 'tw1'])->name('tte1');
    Route::get('/tte2', [TteController::class, 'tw2'])->name('tte2');
    Route::get('/tte3', [TteController::class, 'tw3'])->name('tte3');
    Route::get('/tte4', [TteController::class, 'tw4'])->name('tte4');
});
