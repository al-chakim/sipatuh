...
class TtebogorController extends Controller
{
    ...
    {
        //
        $terima1as = P1a::select()->where('divisi','PT. PLN (Persero) UPDL BOGOR')->where('wulan','TW I')->where('status','disetujui')->get();
        $terima1a = P1a::select()->where('divisi','PT. PLN (Persero) UPDL BOGOR')->get()->first();
        $terima1bs = P1b::select()->where('divisi','PT. PLN (Persero) UPDL BOGOR')->where('wulan','TW I')->where('status','disetujui')->get();
        $terima1b = P1b::select()->where('divisi','PT. PLN (Persero) UPDL BOGOR')->get()->first();
        $terima2as = P2a::select()->where('divisi','PT. PLN (Persero) UPDL BOGOR')->where('wulan','TW I')->where('status','disetujui')->get();
        $terima2a = P2a::select()->where('divisi','PT. PLN (Persero) UPDL BOGOR')->get()->first();
        $terimabogors = P9a::select()->where('divisi','PT. PLN (Persero) UPDL BOGOR')->where('wulan','TW I')->where('status','disetujui')->get();
        $terimabogor = P9a::select()->where('divisi','PT. PLN (Persero) UPDL BOGOR')->get()->first();
        $qrcode = base64_encode(QrCode::format('svg')->size(100)->errorCorrection('H')->generate('Terverifikasi oleh Admin Lingkungan'));
        $pdf = PDF::loadview('adling.updlbogor.p1.p1a.tte', compact(
            'terimabogors',
            'terimabogor',
            'terima1a',
            'terima1as',
    ...
    {
        //
        $terima1a = P1a::select()->where('divisi','PT. PLN (Persero) UPDL BOGOR')->where('wulan','TW I')->where('status','disetujui')->get();
        $terima1b = P1b::select()->where('divisi','PT. PLN (Persero) UPDL BOGOR')->where('wulan','TW I')->where('status','disetujui')->get();
        $terima2a = P2a::select()->where('divisi','PT. PLN (Persero) UPDL BOGOR')->where('wulan','TW I')->where('status','disetujui')->get();
        $terimabogors = P9a::select()->where('divisi','PT. PLN (Persero) UPDL BOGOR')->where('wulan','TW II')->where('status','disetujui')->get();
        $terimabogor = P9a::select()->where('divisi','PT. PLN (Persero) UPDL BOGOR')->get()->first();
        $qrcode = base64_encode(QrCode::format('svg')->size(100)->errorCorrection('H')->generate('Terverifikasi oleh Admin Lingkungan'));
    ...
    public function tw3()
    {
        ...
        $terima1b = P1b::select()->where('divisi','PT. PLN (Persero) UPDL BOGOR')->where('wulan','TW I')->where('status','disetujui')->get();
        $terima2a = P2a::select()->where('divisi','PT. PLN (Persero) UPDL BOGOR')->where('wulan','TW I')->where('status','disetujui')->get();
        $terimabogors = P9a::select()->where('divisi','PT. PLN (Persero) UPDL BOGOR')->where('wulan','TW III')->where('status','disetujui')->get();
        $terimabogor = P9a::select()->where('divisi','PT. PLN (Persero) UPDL BOGOR')->get()->first();
        $qrcode = base64_encode(QrCode::format('svg')->size(100)->errorCorrection('H')->generate('Terverifikasi oleh Admin Lingkungan'));
        $pdf = PDF::loadview('adling.updlbogor.p1.p1a.tte', compact('terimabogors','terimabogor','qrcode'));
        return $pdf->stream('Laporan Surat Lingkungan');
    ...
    public function tw4()
    {
        ...
        $terima1b = P1b::select()->where('divisi','PT. PLN (Persero) UPDL BOGOR')->where('wulan','TW I')->where('status','disetujui')->get();
        $terima2a = P2a::select()->where('divisi','PT. PLN (Persero) UPDL BOGOR')->where('wulan','TW I')->where('status','disetujui')->get();
        $terimabogors = P9a::select()->where('divisi','PT. PLN (Persero) UPDL BOGOR')->where('wulan','TW IV')->where('status','disetujui')->get();
        $terimabogor = P9a::select()->where('divisi','PT. PLN (Persero) UPDL BOGOR')->get()->first();
        $qrcode = base64_encode(QrCode::format('svg')->size(100)->errorCorrection('H')->generate('Terverifikasi oleh Admin Lingkungan'));
        $pdf = PDF::loadview('adling.updlbogor.p1.p1a.tte', compact('terimabogors','terimabogor','qrcode'));
        return $pdf->stream('Laporan Surat Lingkungan');
    ...
    // {
    //     $terimabogors = P2b::select()->where('divisi','PT. PLN (Persero) UPDL BOGOR')->where('wulan','TW I')->where('status','disetujui')->get();
    //     $terimabogor = P2b::select()->where('divisi','PT. PLN (Persero) UPDL BOGOR')->get()->first();
    //     $qrcode = base64_encode(QrCode::format('svg')->size(100)->errorCorrection('H')->generate('Admin Lingkungan'));
    ...
    // {
    //     $terimabogors = P2b::select()->where('divisi','PT. PLN (Persero) UPDL BOGOR')->where('wulan','TW II')->where('status','disetujui')->get();
    //     $terimabogor = P2b::select()->where('divisi','PT. PLN (Persero) UPDL BOGOR')->get()->first();
    //     $qrcode = base64_encode(QrCode::format('svg')->size(100)->errorCorrection('H')->generate('Admin Lingkungan'));
    //     $pdf = PDF::loadview('adling.updlbogor.p2.p2b.tte', compact('terimabogors','terimabogor','qrcode'));
    //     return $pdf->stream('Laporan Surat Lingkungan');
    ...
    // {
    //     $terimabogors = P2b::select()->where('divisi','PT. PLN (Persero) UPDL BOGOR')->where('wulan','TW III')->where('status','disetujui')->get();
    //     $terimabogor = P2b::select()->where('divisi','PT. PLN (Persero) UPDL BOGOR')->get()->first();
    //     $qrcode = base64_encode(QrCode::format('svg')->size(100)->errorCorrection('H')->generate('Admin Lingkungan'));
    //     $pdf = PDF::loadview('adling.updlbogor.p2.p2b.tte', compact('terimabogors','terimabogor','qrcode'));
    //     return $pdf->stream('Laporan Surat Lingkungan');
    ...
    // {
    //     $terimabogors = P2b::select()->where('divisi','PT. PLN (Persero) UPDL BOGOR')->where('wulan','TW IV')->where('status','disetujui')->get();
    //     $terimabogor = P2b::select()->where('divisi','PT. PLN (Persero) UPDL BOGOR')->get()->first();
    //     $qrcode = base64_encode(QrCode::format('svg')->size(100)->errorCorrection('H')->generate('Admin Lingkungan'));
    //     $pdf = PDF::loadview('adling.updlbogor.p2.p2b.tte', compact('terimabogors','terimabogor','qrcode'));
    //     return $pdf->stream('Laporan Surat Lingkungan');
    ...
    // {
    //     $terimabogors = P2c::select()->where('divisi','PT. PLN (Persero) UPDL BOGOR')->where('wulan','TW I')->where('status','disetujui')->get();
    //     $terimabogor = P2c::select()->where('divisi','PT. PLN (Persero) UPDL BOGOR')->get()->first();
    //     $qrcode = base64_encode(QrCode::format('svg')->size(100)->errorCorrection('H')->generate('Admin Lingkungan'));
    ...
    // {
    //     $terimabogors = P2c::select()->where('divisi','PT. PLN (Persero) UPDL BOGOR')->where('wulan','TW II')->where('status','disetujui')->get();
    //     $terimabogor = P2c::select()->where('divisi','PT. PLN (Persero) UPDL BOGOR')->get()->first();
    //     $qrcode = base64_encode(QrCode::format('svg')->size(100)->errorCorrection('H')->generate('Admin Lingkungan'));
    //     $pdf = PDF::loadview('adling.updlbogor.p2.p2c.tte', compact('terimabogors','terimabogor','qrcode'));
    //     return $pdf->stream('Laporan Surat Lingkungan');
    ...
    // {
    //     $terimabogors = P2c::select()->where('divisi','PT. PLN (Persero) UPDL BOGOR')->where('wulan','TW III')->where('status','disetujui')->get();
    //     $terimabogor = P2c::select()->where('divisi','PT. PLN (Persero) UPDL BOGOR')->get()->first();
    //     $qrcode = base64_encode(QrCode::format('svg')->size(100)->errorCorrection('H')->generate('Admin Lingkungan'));
    //     $pdf = PDF::loadview('adling.updlbogor.p2.p2c.tte', compact('terimabogors','terimabogor','qrcode'));
    //     return $pdf->stream('Laporan Surat Lingkungan');
    ...
    // {
    //     $terimabogors = P2c::select()->where('divisi','PT. PLN (Persero) UPDL BOGOR')->where('wulan','TW IV')->where('status','disetujui')->get();
    //     $terimabogor = P2c::select()->where('divisi','PT. PLN (Persero) UPDL BOGOR')->get()->first();
    //     $qrcode = base64_encode(QrCode::format('svg')->size(100)->errorCorrection('H')->generate('Admin Lingkungan'));
    //     $pdf = PDF::loadview('adling.updlbogor.p2.p2c.tte', compact('terimabogors','terimabogor','qrcode'));
    //     return $pdf->stream('Laporan Surat Lingkungan');
    ...
    // {
    //     $terimabogors = P2d::select()->where('divisi','PT. PLN (Persero) UPDL BOGOR')->where('wulan','TW I')->where('status','disetujui')->get();
    //     $terimabogor = P2d::select()->where('divisi','PT. PLN (Persero) UPDL BOGOR')->get()->first();
    //     $qrcode = base64_encode(QrCode::format('svg')->size(100)->errorCorrection('H')->generate('Admin Lingkungan'));
    ...
    // {
    //     $terimabogors = P2d::select()->where('divisi','PT. PLN (Persero) UPDL BOGOR')->where('wulan','TW II')->where('status','disetujui')->get();
    //     $terimabogor = P2d::select()->where('divisi','PT. PLN (Persero) UPDL BOGOR')->get()->first();
    //     $qrcode = base64_encode(QrCode::format('svg')->size(100)->errorCorrection('H')->generate('Admin Lingkungan'));
    //     $pdf = PDF::loadview('adling.updlbogor.p2.p2d.tte', compact('terimabogors','terimabogor','qrcode'));
    //     return $pdf->stream('Laporan Surat Lingkungan');
    ...
    // {
    //     $terimabogors = P2d::select()->where('divisi','PT. PLN (Persero) UPDL BOGOR')->where('wulan','TW III')->where('status','disetujui')->get();
    //     $terimabogor = P2d::select()->where('divisi','PT. PLN (Persero) UPDL BOGOR')->get()->first();
    //     $qrcode = base64_encode(QrCode::format('svg')->size(100)->errorCorrection('H')->generate('Admin Lingkungan'));
    //     $pdf = PDF::loadview('adling.updlbogor.p2.p2d.tte', compact('terimabogors','terimabogor','qrcode'));
    //     return $pdf->stream('Laporan Surat Lingkungan');
    ...
    // {
    //     $terimabogors = P2d::select()->where('divisi','PT. PLN (Persero) UPDL BOGOR')->where('wulan','TW IV')->where('status','disetujui')->get();
    //     $terimabogor = P2d::select()->where('divisi','PT. PLN (Persero) UPDL BOGOR')->get()->first();
    //     $qrcode = base64_encode(QrCode::format('svg')->size(100)->errorCorrection('H')->generate('Admin Lingkungan'));
    //     $pdf = PDF::loadview('adling.updlbogor.p2.p2d.tte', compact('terimabogors','terimabogor','qrcode'));
    //     return $pdf->stream('Laporan Surat Lingkungan');
